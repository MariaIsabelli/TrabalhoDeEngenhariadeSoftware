            ...
            <table class="text-center table table-bordered">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    $SQL = "SELECT id_cliente, nome, cpf FROM cliente WHERE ativo = 1;";
                    ...
                    if (mysqli_num_rows($consulta) > 0){
                      ...
                      while ($usuario = mysqli_fetch_assoc($consulta)){
                        ?>
                        <tr>
                          <th scope="row"><?php print($usuario["id_cliente"]); ?></th>
                          <td><?php print($usuario["nome"]); ?></td>
                          <td><?php print($usuario["cpf"]); ?></td>
                          <td><a href="form-view-client.php?id=<?php print($usuario["id_cliente"]); ?>"><i class="bi bi-eye-fill"></i></a></td>
                          <td><a href="form-edit-client.php?id=<?php print($usuario["id_cliente"]); ?>"><i class="bi bi-pencil-square"></i></a></td>
                          <td><a href="proccess-delete-client.php?id=<?php print($usuario["id_cliente"]); ?>"><i class="bi bi-trash3-fill"></i></a></td>
                        </tr>
                        <?php
                      }
